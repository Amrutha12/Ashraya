<%@ Page Title="" Language="C#" MasterPageFile="~/AgencyMaster.master" AutoEventWireup="true" CodeFile="ViewRspnsFrmNGO.aspx.cs" Inherits="ViewRspnsFrmNGO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="Label2" runat="server" Text="Successfully Send to ADMIN" 
